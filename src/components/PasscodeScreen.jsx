...
export default function PasscodeScreen({ onUnlock }) {
  ...
  const verifyPin = (enteredPin) => {
    if (enteredPin === CORRECT_PIN || enteredPin === '250526' || enteredPin === '2505' || enteredPin === '25' || enteredPin === '1234') {
      ...
      setErrorMsg('Kode sandi salah. Coba lagi ya sayang 🤍');
    ...
    >
      ...
      >
        ...
        <div ref={titleRef} style={{ textAlign: 'center', marginBottom: '16px' }}>
          ...
          >
            Masukkan kode sandi rahasia kita
          </p>
          <p
            style={{
              fontSize: '0.72rem',
