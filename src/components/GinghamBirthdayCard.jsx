    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '18px' }}>
        ...
        <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
          Ketuk kartu untuk membuka kejutan ulang tahun Bebe ✨
        </p>
      </div>
          ...
          >
            ...
            <div ref={innerContentRef} style={{ opacity: 0, position: 'relative', zIndex: 2 }}>
              ...
              <p style={{ fontSize: '0.85rem', lineHeight: '1.55', color: '#590008', fontWeight: '500' }}>
                Kamu selalu membawa kehangatan, tawa, dan kebahagiaan di setiap hariku. Semoga di usiamu yang ke-25 ini, kamu selalu diberikan kesehatan, kebahagiaan tak terhingga, dan semua impianmu tercapai! 💕
              </p>
            </div>
